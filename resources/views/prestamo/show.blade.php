                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Correo:</th>
                                                <td>{{ $prestamo->persona->correo }}</td>
                                            </tr>
                                            <tr>
                                                <th>Celular:</th>
                                                <td>{{ $prestamo->persona->celular }}</td>
                                            </tr>
                                            <tr>
                                                <th>Programa:</th>
                                                <td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>Equipo:</th>
                                                <td>{{ $prestamo->equipo->id }}</td>
                                            </tr>
                                            <tr>
                                                <th>Marca:</th>
                                                <td>{{ $prestamo->equipo->marca }}</td>
                                            </tr>
                                            <tr>
                                                <th>Modelo:</th>
                                            ...
                                            <tr>
                                                <th>Serie:</th>
                                                <td>{{ $prestamo->equipo->serie }}</td>
                                            </tr>
                                            <tr>
                                                <th>Placa:</th>
                                                <td>{{ $prestamo->equipo->placa_inventario }}</td>
                                            </tr>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $prestamo->fecha_hora_prestamo }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <th>Aula:</th>
                                                <td>{{ $prestamo->salon ? $prestamo->salon->descripcion : '' }}</td>
                                            </tr>
                                            <tr>
                                                <th>Tipo de Aula:</th>
