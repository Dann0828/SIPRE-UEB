                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <form method="GET" role="form" action="{{ route('prestamo.buscarAdministrativoEnAPI') }}">
                                    @csrf
                            ...
                            <div class="col-md-4">
                                ...
                                <form method="GET" role="form" action="{{ route('prestamo.buscarEstudianteEnAPI') }}">
                                    @csrf
                                    <div class="mb-3 input-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <form method="GET" role="form" action="{{ route('prestamo.buscarDocenteEnAPI') }}">
                                    @csrf
                                    <div class="mb-3 input-group">
...
<script>
    $('form[id^="searchForm"]').submit(function (event) {
        ...
        var formActionCreate = '{{ route('prestamo.create') }}';
