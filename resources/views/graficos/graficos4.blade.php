        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div>
                        <h1> Estadísticas de Mantenimientos para Periféricos y Auxiliares</h1>
                        <br>
                        <div class="row">
...
<script>
    ...
    var mes = <?php echo json_encode($data2); ?>;
    var tiposP = <?php echo json_encode($data3); ?>;
...
Highcharts.chart('dashboard-col-3', {
    ...
    title: {
        text: 'Mantenimientos por Tipo de Periférico',
        align: 'left'
    },
    subtitle: {
        text: '',
    ...
    xAxis: {
        categories: tiposP.map(item => item.name),
        labels: {
            skew3d: true,
            style: {
                fontSize: '16px'
